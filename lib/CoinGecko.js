...
class CoinGecko {
    ...
    get coins() {
        ...
        return {
             ...
             * @async
             * @param {object} contractAddress - Token’s contract address
             * @param {string} coinId [default: ethereum] - (Required) Asset platform (only ethereum is supported at this moment)
             * @returns {ReturnObject}
             */
            fetchCoinContractInfo: async(contractAddress, coinId='ethereum') => {
                //Must have contractAddress, coinId
                ...
                const method = 'GET';
                let path = `/${pathPrefix}/${coinId}/contract/${contractAddress}`;
